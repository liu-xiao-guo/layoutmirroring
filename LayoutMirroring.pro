...
UBUNTU_TRANSLATION_DOMAIN="layoutmirroring.liu-xiao-guo"
...
aptest.commands = bash $$PWD/LayoutMirroring/tests/autopilot/run
aptest.depends  = sub-LayoutMirroring

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/LayoutMirroring/tests/unit 
unittest.depends  = sub-LayoutMirroring
